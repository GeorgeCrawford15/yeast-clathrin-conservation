...
**Note:** This repository documents the workflow and analysis of clathrin heavy chain 1 (CHC1) and light chain 1 (CLC1) conservation across 12 yeast clades. It includes sequence organization notebooks and a heatmap generation pipeline.  
